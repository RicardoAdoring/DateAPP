...
OLLAMA_FALLBACK_BASE_URL = os.getenv(
    "OLLAMA_FALLBACK_BASE_URL",
    "http://127.0.0.1:11434/v1",
)
OLLAMA_FALLBACK_API_KEY = os.getenv("OLLAMA_FALLBACK_API_KEY", "ollama")
OLLAMA_FALLBACK_TIMEOUT_SECONDS = int(os.getenv("OLLAMA_FALLBACK_TIMEOUT_SECONDS", "20"))
OLLAMA_FALLBACK_MAX_RETRIES = int(os.getenv("OLLAMA_FALLBACK_MAX_RETRIES", "0"))
